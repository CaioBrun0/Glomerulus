...
import MinhaConta from '../../pages/Specialist/MinhaConta/MinhaConta';
  ...
  return (
    <div className="princ">
      <div className="icons">
        ...
        {/* Minha Conta */}
        {/* Minha Conta (Engrenagem) */}
        <div 
            className={`icon-wrapper ${viewProfileModal ? 'active' : ''}`}
            onClick={() => setViewProfileModal(true)} // Abre o modal
            title="Minha Conta"
        >
     ...
     {/* 2. Integração do Modal MinhaConta */}
      <MinhaConta 
