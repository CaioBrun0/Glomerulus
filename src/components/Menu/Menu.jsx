  ...
  return (
    <div className="princ">
      <div className="icons">
        ...
        {/* HOME - Alterado para navegar para a home do especialista */}
        <div 
        ...
        >
            ...
            <path d="M28.8986 13.2833L16.5387 1.1053L15.7102 0.288604C15.5214 0.103748 15.2661 0 15.0001 0C14.734 0 14.4787 0.103748 14.2899 0.288604L1.1015 13.2833C0.908072 13.4732 0.755206 13.6994 0.65192 13.9485C0.548634 14.1976 0.497023 14.4646 0.500133 14.7338C0.512928 15.8437 1.45016 16.7298 2.57612 16.7298H3.93559V27H26.0645V16.7298H27.4528C27.9998 16.7298 28.5148 16.5185 28.9018 16.137C29.0924 15.9497 29.2434 15.727 29.3461 15.4818C29.4488 15.2366 29.5011 14.9738 29.5 14.7085C29.5 14.1725 29.2857 13.6648 28.8986 13.2833ZM16.7914 24.7296H13.2088V18.297H16.7914V24.7296ZM23.7614 14.4594V24.7296H18.8386V17.5402C18.8386 16.8433 18.266 16.2789 17.5591 16.2789H12.4411C11.7341 16.2789 11.1616 16.8433 11.1616 17.5402V24.7296H6.23869V14.4594H3.16789L15.0033 2.80176L15.7422 3.53017L26.8354 14.4594H23.7614Z" fill="black"/>
            </svg>
        </div>

        {/* ... restante dos ícones (HISTORY, FORMS, ADM) permanecem iguais ... */}
        
        {/* HISTORY */}
        <div 
            className='icon-wrapper' 
            onClick={() => navigate("/historic")} // Navegação direta!
            style={{ cursor: 'pointer' }}
            title="Meu Histórico de Avaliações"
        >
            <svg className="icon history" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M21.2099 15.8901C20.5737 17.3946 19.5787 18.7203 18.3118 19.7514C17.0449 20.7825 15.5447 21.4875 13.9424 21.8049C12.34 22.1222 10.6843 22.0422 9.12006 21.5719C7.55578 21.1015 6.13054 20.2551 4.96893 19.1067C3.80733 17.9583 2.94473 16.5428 2.45655 14.984C1.96837 13.4252 1.86948 11.7706 2.16851 10.1647C2.46755 8.55886 3.15541 7.05071 4.17196 5.77211C5.18851 4.49351 6.5028 3.4834 7.99992 2.83008" stroke="#191D23" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M22 12C22 10.6868 21.7413 9.38642 21.2388 8.17317C20.7362 6.95991 19.9997 5.85752 19.0711 4.92893C18.1425 4.00035 17.0401 3.26375 15.8268 2.7612C14.6136 2.25866 13.3132 2 12 2V12H22Z" stroke="#191D23" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
        </div>

        {/* FORMS */}
        <div className='icon-wrapper'>
            <svg className='icon forms' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                <path d="M14 2H6C5.46957 2 4.96086 2.21071 4.58579 2.58579C4.21071 2.96086 4 3.46957 4 4V20C4 20.5304 4.21071 21.0391 4.58579 21.4142C4.96086 21.7893 5.46957 22 6 22H18C18.5304 22 19.0391 21.7893 19.4142 21.4142C19.7893 21.0391 20 20.5304 20 20V8L14 2Z" stroke="#191D23" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M16 17H8" stroke="#191D23" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M16 13H8" stroke="#191D23" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M10 9H8" stroke="#191D23" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
                <path d="M14 2V8H20" stroke="#191D23" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
            </svg>
        </div>
        ...
        <div className='icon-wrapper' onClick={() => setViewModal(true)}>
            <svg className='icon adm' xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none">
                ...
                <path d="M16 3.12988C16.8604 3.35018 17.623 3.85058 18.1676 4.55219C18.7122 5.2538 19.0078 6.11671 19.0078 7.00488C19.0078 7.89305 18.7122 8.75596 18.1676 9.45757C17.623 10.1592 16.8604 10.6596 16 10.8799" stroke="#191D23" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"/>
